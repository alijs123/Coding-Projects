...
* [Spring Data MongoDB](https://docs.spring.io/spring-boot/docs/3.3.0-M2/reference/htmlsingle/index.html#data.nosql.mongodb)
...
* [Spring Web Services](https://docs.spring.io/spring-boot/docs/3.3.0-M2/reference/htmlsingle/index.html#io.webservices)
...
* [WebSocket](https://docs.spring.io/spring-boot/docs/3.3.0-M2/reference/htmlsingle/index.html#messaging.websockets)
